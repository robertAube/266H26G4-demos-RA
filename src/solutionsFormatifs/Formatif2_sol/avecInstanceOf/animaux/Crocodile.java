...
public class Crocodile {
    ...
    public final static int TAILLE_MAX = 5;
    ...
    public static final int AJUSTEMENT_SERPENT = 20;
    ...
    public Crocodile(int nombreDeDents, double ptaille) {
        this.nombreDeDents = nombreDeDents;
        ...
        assert valideTaille(ptaille) : "mauvaise taille";
    ...
    public String toString() {
        return "Crocodile [nombreDeDents=" + nombreDeDents + ", espece=" + espece +"_" + identifiant+ ", taille="
                + Math.round(taille * 100.0) / 100.0 + ", nombreDeRepas=" + nombreDeRepas + "]";
    }
    ...
    /**
     * Fait combattre 2 crocodiles. Celui dont le nombre de dent multiplié par la
    ...
    public Crocodile combattre(Crocodile opposant) {
        ...
        gagnant.taille += perdant.getTaille() * FACTEUR_GAIN_TAILLE;
    ...
    public Object combattre(Serpent opposant) {
        assert !opposant.equals(this) : "Se combat lui-même";
        assert opposant != null : "null param";

        double forcePremier = nombreDeDents * taille;
        double forceSecond = opposant.getLongueur() * opposant.getTaille()* AJUSTEMENT_SERPENT;
        ...
        if (Math.abs(forcePremier - forceSecond) > SEUIL_DE_VICTOIRE) {
            ...
            perdant = opposant;
            this.taille += opposant.getTaille() * FACTEUR_GAIN_TAILLE;
            this.nombreDeRepas++;
        } else if(Math.abs(forceSecond-forcePremier) > SEUIL_DE_VICTOIRE) {
            // Le second l'emporte
            perdant = this;
