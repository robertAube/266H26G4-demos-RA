...
public class FichierBinaireInputOutput_vNbElement {
    ...
    private String nomFichier = "testBin.bin";
    ...
    public FichierBinaireInputOutput_vNbElement() {
    ...
    private static boolean ecrire(String nomFichier, Object[][] data) {
        ...
        try {
            ...
            dos.writeInt(data.length); //mettre dans le fichier le nombre de lignes pour lire le même nombre à la lecture
    ...
    private static boolean lireEtAfficher(String nomFichier) {
        ...
        try {
            ...
            e.printStackTrace();
            lectureReussie = false; //dans ce cas, ça ne devrait pas arriver
        } catch (IOException e) {
    ...
    public static void main(String arguments[]) {
        new FichierBinaireInputOutput_vNbElement();
